...
public class Engineering3D_to_WGS842D implements ICoordinateTransform {
	...
	public double[] transform(double[] in, CoordinateReferenceSystem _src, CoordinateReferenceSystem _dst) {
		...
		if (in[2] != in[2]) 
			return new double[] {dest.lat2, dest.lon2, 0};
