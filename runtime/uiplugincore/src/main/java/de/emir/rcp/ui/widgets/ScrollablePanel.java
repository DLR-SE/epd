...
/**
 * License Information: "We assume no responsibility for the code. You are free to use and/or modify and/or distribute
 * any or all code posted on the Java Tips Weblog without restriction. A credit in the code comments would be nice, but
 * not in any way mandatory." FROM: https://tips4java.wordpress.com/2009/12/20/scrollable-panel/
 * 
 * 
 * A panel that implements the Scrollable interface. This class allows you to customize the scrollable features by using
 * newly provided setter methods so you don't have to extend this class every time.
 *
 * Scrollable amounts can be specifed as a percentage of the viewport size or as an actual pixel value. The amount can
 * be changed for both unit and block scrolling for both horizontal and vertical scrollbars.
 *
...
public class ScrollablePanel extends JPanel implements Scrollable, SwingConstants {
     ...
     * 
     */
    private static final long serialVersionUID = 5941698672093754328L;
     ...
     *
     * @param orientation
     *            specify the scrolling orientation. Must be either: SwingContants.HORIZONTAL or SwingContants.VERTICAL.
     ...
     *            specify the scrolling orientation. Must be either: SwingContants.HORIZONTAL or SwingContants.VERTICAL.
     * @param info
     *            An IncrementInfo object containing information of how to calculate the scrollable amount.
     */
