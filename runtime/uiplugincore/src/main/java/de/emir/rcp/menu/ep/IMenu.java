...
public interface IMenu {
     ...
     *
     * @param id A unique identifier (Within all menu entries with the same parent element)
     ...
     *
     * @param id  A unique identifier (Within all menu entries with the same parent element)
     * @param cmd The command to be triggered, identified by its id
     * @return A representation of the new menu item
     */
     ...
     *
     * @param siblingID The identifier of another menu entry. Attention: The other menu entry must have the same parent
     *                  element as this one.
     ...
     *
     * @param iconPath Relative path to the icon file (e.g. from resources folder).
     * @return
     */
     ...
     * @param type      Define a data type handled by these radio buttons. The specified commands handler class has to be of
     ...
     * @param commandID The unique identifier of the command. Commands handler class has to extend type
     ...
     *                  type AbstractRadioGroupCommand. If the user selects an option of the RadioGroup, its value is passed
     *                  to the command. Selectable options can be defined within the RadioGroup (See IRadioGroup).
     * @param commandID The command. Commands handler class has to extend type AbstractRadioGroupCommand
     * @return A representation of the new radio group
     */
     ...
     * @param id      A unique identifier (Within all menu entries with the same parent element)
     * @param label   The menu label
     * @param tooltip The menu tooltip
     * @return A representation of the new menu
     */
