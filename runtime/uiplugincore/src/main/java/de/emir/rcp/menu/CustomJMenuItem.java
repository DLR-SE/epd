...
public class CustomJMenuItem extends JMenuItem implements Observer {

    private static final long serialVersionUID = -5754187685208816015L;
    ...
    public CustomJMenuItem(String label, ImageIcon icon, String tooltip, String fullPath, AbstractUIPlugin provider) {
        super(label);
    ...
    private void init() {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseExited(MouseEvent e) {
                CustomJMenuItem.this.setCursor(Cursor.getDefaultCursor());

            }

            @Override
            public void mouseEntered(MouseEvent e) {
                CustomJMenuItem.this.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
