...
public class CustomJToggleButton extends JToggleButton implements Observer {
    ...
    private void init() {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseExited(MouseEvent e) {
                CustomJToggleButton.this.setCursor(Cursor.getDefaultCursor());

            }

            @Override
            public void mouseEntered(MouseEvent e) {
                CustomJToggleButton.this.setCursor(Cursor.getPredefinedCursor(Cursor.HAND_CURSOR));
    ...
    protected void executeCommand() {
        if (command != null && command.canExecute() == true) {
            command.setChecked(isSelected()); // notify the command about the new state
            command.execute();
        }
