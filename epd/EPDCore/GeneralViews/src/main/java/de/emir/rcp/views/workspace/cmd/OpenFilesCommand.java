...
public class OpenFilesCommand extends AbstractCommand {
	...
	public void execute() {
		...
		for (Object o : selection) {
			...
			boolean openSuccess = em.openFile((File) o);
			...
			OpenWithEditorDialog dialog = new OpenWithEditorDialog(mw, "No suitable editor could be found.",
					((File) o).getName());
