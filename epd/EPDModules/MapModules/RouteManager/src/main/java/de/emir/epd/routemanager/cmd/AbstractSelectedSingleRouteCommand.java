...
public abstract class AbstractSelectedSingleRouteCommand extends AbstractCommand {

    public AbstractSelectedSingleRouteCommand() {
    ...
    protected Route getSelectedRoute() {
        ...
        if (selection.size() > 0 && selection.get(0) instanceof Route) {
            return (Route) selection.get(0);
        }
